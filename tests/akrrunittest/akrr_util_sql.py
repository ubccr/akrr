...
class Test_akrr_util_sql_FunctionsSQL(unittest.TestCase):
    """this tests require MySQL server"""
    def __init__(self, methodName='runTest'):
        super(Test_akrr_util_sql_FunctionsSQL, self).__init__(methodName)
        
        self.su_sql="root:test@localhost"
    ...
    def test_db_check_priv(self):
        ...
        #create user
        su_cur.execute("CREATE USER IF NOT EXISTS %s@%s IDENTIFIED BY %s",(self.user1,client_host,self.password1))
